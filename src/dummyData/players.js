...
const players = [
  ...
  new Player('26','Ken', 'Johnston').setType(type.CONTRACT).setRank(1).addInst(insts.violin1).setEmail('kenjfiddle@gmail.com'),
  new Player('27','Minju', 'Kim').setType(type.CONTRACT).setRank(2).addInst(insts.violin1).setEmail('minjuk622@gmail'),

  new Player('28','Sandro', 'Leal-Santiesteban').setType(type.CONTRACT).setRank(2).addInst(insts.violin1),
  new Player('29','Joshua', 'Huang').setType(type.CONTRACT).setRank(3).addInst(insts.violin1),
  new Player('30','Melissa', 'Hernandez').setType(type.CONTRACT).setRank(3).addInst(insts.violin1),
  new Player('31','Alexander', 'Hettinga').setType(type.CONTRACT).setRank(3).addInst(insts.violin1),
  new Player('32','Stefanie', 'Schore').setType(type.CONTRACT).setRank(3).addInst(insts.violin1),
  new Player('33','Yejee', 'Kim').setType(type.CONTRACT).setRank(3).addInst(insts.violin1).setEmail('kenjfiddle@gmail.com'),
  new Player('34','Maura', 'Pelinsky').setType(type.CONTRACT).setRank(3).addInst(insts.violin1).setEmail('kenjfiddle@gmail.com'),
  new Player('35','Janice', 'Carlson').setType(type.CONTRACT).setRank(3).addInst(insts.violin1).setEmail('kenjfiddle@gmail.com'),
  new Player('36','Jonathan', 'Moser').setType(type.CONTRACT).setRank(1).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('37','Jennifer', 'Jansen').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('38','Tobias', 'Chisnall').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('39','Jiyeon', 'Yeo').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('40','Colleen', 'Vanderzyden').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('41','Karen', 'Ferren').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('42','Howard', 'Lyon').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
  new Player('43','Emilie', 'Engel').setType(type.CONTRACT).setRank(3).addInst(insts.violin2).setEmail('kenjfiddle@gmail.com'),
